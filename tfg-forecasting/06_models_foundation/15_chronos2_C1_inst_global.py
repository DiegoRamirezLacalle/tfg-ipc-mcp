...
Arquitectura idéntica a 09_chronos2_C1_inst.py (España) pero sobre
features_c1_global_institutional.parquet y target cpi_global_rate.
"""
...
def compute_subperiod_metrics(df_preds, mase_scale):
    res = {}
...
def main():
    ...
    json.dump({MODEL_NAME: metrics, "subperiods": sp_metrics},
