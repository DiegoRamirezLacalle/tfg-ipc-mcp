"""
29_timegpt_C1_full_europe.py — TimeGPT C1_full HICP Eurozona

TimeGPT nativo con todas las covariables (institucionales + MCP).
...
MODEL_NAME    = "timegpt_C1_full_europe"
...
def main():
    ...
    for ref_name in ["timegpt_C0_europe", "timegpt_C1_inst_europe", "timegpt_C1_mcp_europe"]:
