"""
26_timesfm_C1_full_europe.py — TimesFM C1_full HICP Eurozona

Arquitectura: TimesFM base + Ridge correction con todas las seniales (inst + MCP).
"""
...
MODEL_NAME    = "timesfm_C1_full_europe"
...
def main():
    ...
    print(f"Total covariables: {len(XREG_COVS)}")
    print("=" * 60)
    ...
    for ref_name in ["timesfm_C0_europe", "timesfm_C1_inst_europe", "timesfm_C1_mcp_europe"]:
