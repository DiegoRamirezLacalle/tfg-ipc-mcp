...
Arquitectura: TimesFM base (contexto cpi_global_rate completo 2002+) + Ridge correction.
Ridge ajustado sobre ventana 2002:origin con señales institucionales globales.

Covariables Ridge (top-3 por correlación):
...
MODEL_NAME    = "timesfm_C1_inst_global"
TEST_END_TS   = pd.Timestamp(DATE_TEST_END)
RIDGE_ALPHA   = 1.0

XREG_COVS = ["imf_comm_ma3", "brent_log_ma3", "gscpi_ma3"]
