"""
05_metrics_baseline_europe.py — Informe de metricas baseline HICP Eurozona

Lee rolling_metrics_europe.json y genera un informe de texto + JSON consolidado.
...
def main():
    ...
    if not metrics_path.exists():
        print("ERROR: rolling_metrics_europe.json no encontrado. Ejecuta primero el script 04.")
        return
    ...
    print(f"\nGuardado: baseline_europe_report.txt  |  baseline_europe_summary.json")
